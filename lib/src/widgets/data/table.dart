            ...
            for (final column in columns)
              FlintElement(
                ...
                props: mergeComponentProps(
                  {'scope': 'col'},
                  className:
                      joinClassNames([headerClassName, column.className]),
                  defaultStyle: {
                    'padding': '12px',
                ...
                children:
                    normalizeChildren(column.header ?? column.label, const []),
              ),
          ],
        ),
      ],
              ...
              for (final column in columns)
                FlintElement(
                  ...
                  props: mergeComponentProps(
                    const {},
                    className:
                        joinClassNames([cellClassName, column.className]),
                    defaultStyle: {
                      'padding': '12px',
                      'text-align': column.align ?? 'left',
                  ...
                  children:
                      normalizeChildren(row.cells[column.key] ?? '', const []),
                ),
              if (row.actions != null)
                FlintElement(
                  'td',
